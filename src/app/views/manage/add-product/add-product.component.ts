...
export class AddProductComponent implements OnInit {
  ...
  addProduct(): void {
    const reqBody = {};
    reqBody[APP_CONSTANTS.FIELD_PRODUCT] = {}
    for (const key in new Product()) {
      console.log(key, this.product, reqBody[APP_CONSTANTS.FIELD_PRODUCT])
      reqBody[APP_CONSTANTS.FIELD_PRODUCT][key] = this.product[key];
    }
